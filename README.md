...
├── Images/
│   ├── 2D_PCB/          (PCB layer views: Top, Bottom, C2, C63)
│   ├── 3D_PCB/          (3D renders of the PCB)
│   ├── InkTime/         (Watch assembly renders)
...
| Top View | Side View (Buttons) | USB-C Port |
|----------|---------------------|------------|
...
|-------------|--------------|
| ![3D Top](Images/3D_PCB/PCB3D_Top.png) | ![3D Side](Images/3D_PCB/PCB3D_Side.png) |

### PCB Layers

| Top Layer | Inner Layer 2 (GND) | Inner Layer 63 (Signal) | Bottom Layer |
|-----------|---------------------|------------------------|--------------|
| ![Top](Images/2D_PCB/PCB_Top.png) | ![C2](Images/2D_PCB/PCB_C2.png) | ![C63](Images/2D_PCB/PCB_C63.png) | ![Bot](Images/2D_PCB/PCB_Bottom.png) |

### Schematic

| Page 1 | Page 2 |
|--------|--------|
| ![Sch1](Images/Schematic/Schematic1.png) | ![Sch2](Images/Schematic/Schematic2.png) |

## License

This project is open source hardware, licensed under the [Apache License 2.0](LICENSE).
